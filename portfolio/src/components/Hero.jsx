...
function Hero() {
  return (
    <div className='relative flex min-h-screen'>
      <div className="theme-container absolute top-0 right-0 h-[90vh] w-[32vw] bg-yellw ">
      ...
      <div className=" relative h-[90vh]  w-[68vw] bg-bl">
        ...
        <div className='ps-72 max-w-screen-md '>
          <h2 className="text-yellw font-semibold text-4xl -mt-12 ">ceren</h2>

          <div className='mt-36 space-y-7'>
            ...
            <div className="flex space-x-4 ">
              <div className="github-button flex items-center ">
                <button
                  ...
                  type="button"
                  onClick=""
                  className="bg-white text-xl text-indigo-700 font-medium px-4 py-3 rounded shadow hover:bg-gray-100"
                >
